      ...
      <div className="relative w-full flex">
        <ScrollAnimationWrapper className="rounded-lg w-full grid grid-flow-row sm:grid-flow-row grid-cols-1 sm:grid-cols-3 py-9 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-gray-100 bg-white-500 z-10">
          {listUser.map((listUsers, index) => (
            <motion.div
              className="flex items-center border-0 justify-start sm:justify-center py-4 sm:py-6 w-8/12 px-4 sm:w-auto mx-auto sm:mx-0"
              key={index}
              custom={{ duration: 2 + index }}
              variants={scrollAnimation}
            >
              <div className="flex mx-auto w-40 sm:w-auto border-0">
                <div className="flex border-0 items-center justify-center bg-orange-100 w-12 h-12 mr-6 rounded-full">
                ...
                <div className="flex flex-col border-0">
                  ...
                  <p className="text-lg text-black-500">{t(listUsers.name)}</p>
                </div>
              </div>
            </motion.div>
          ))}
