    ...
    >
      ...
      <ScrollAnimationWrapper className="flex items-center w-full">
        ...
        >
          ...
          <ul className="text-black-500 list-none space-y-2">
            {features.map((feature, index) => (
              ...
              >
                <span className="w-5 h-5 flex-shrink-0 mr-2">
                  ✅
                </span>
    ...
    >
      ...
      <ScrollAnimationWrapper className="flex items-center w-full">
        <motion.div
          ...
          className="w-full bg-white rounded-2xl p-6 shadow-xl border border-gray-100"
        >
          {/* Title */}
